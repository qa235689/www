				...
				<div id="id_input_button">
					<fieldset>
                        ...
                        <div class="telBox">
                            ...
                            <input class="find_input" type="text" id="hp2" name="hp2" title="연락처 가운데 4자리를 입력하세요." maxlength="4" placeholder="(ex. 1111)"> -
                            <label class="hidden" for="hp3">연락처 마지막 4자리</label>
                            <input class="find_input" type="text" id="hp3" name="hp3" title="연락처 마지막 4자리를 입력하세요." maxlength="4" placeholder="(ex. 2222)">
                        </div>
                        <label for="fineid" class="hidden">아이디찾기</label>
                        <input type="button" value="아이디찾기" class="find" id="fineid" >
                    </fieldset>
