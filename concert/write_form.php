...
<body>
    <div class="wrap">
        ...
        <div class="sub_menu">
            ...
            <ul>
                <li class="current"><a href="concert/list.php">이벤트안내</a></li>
                <li><a href="../free/list.php">당첨자발표</a></li>
            </ul>
        </div>
        ...
        <article id="content">
            <div class="title_area">
                <div class="line_map">
                    <span class="hidden">HOME</span><i class="fas fa-home"></i> &gt; 이벤트 &gt; <strong>이벤트안내</strong>
                </div>
                <h2>이벤트안내</h2>
            </div>
